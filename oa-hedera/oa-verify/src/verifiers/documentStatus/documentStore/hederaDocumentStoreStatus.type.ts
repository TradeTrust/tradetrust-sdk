 ...
 * Fragments
 */
export type OpenAttestationHederaDocumentStoreStatusFragmentValidFragmentV2 = ValidVerificationFragment<ValidDocumentStoreDataV2>;
export type OpenAttestationHederaDocumentStoreStatusFragmentInvalidFragmentV2 = InvalidVerificationFragment<InvalidDocumentStoreDataV2>;
export type OpenAttestationHederaDocumentStoreStatusFragmentValidFragmentV3 = ValidVerificationFragment<ValidDocumentStoreDataV3>;
export type OpenAttestationHederaDocumentStoreStatusFragmentInvalidFragmentV3 = InvalidVerificationFragment<InvalidDocumentStoreDataV3>;
export type OpenAttestationHederaDocumentStoreStatusErrorFragment = ErrorVerificationFragment<any>;
export type OpenAttestationHederaDocumentStoreStatusFragment =
  | OpenAttestationHederaDocumentStoreStatusFragmentValidFragmentV2
  | OpenAttestationHederaDocumentStoreStatusFragmentInvalidFragmentV2
  | OpenAttestationHederaDocumentStoreStatusFragmentValidFragmentV3
  | OpenAttestationHederaDocumentStoreStatusFragmentInvalidFragmentV3
  | OpenAttestationHederaDocumentStoreStatusErrorFragment
  | SkippedVerificationFragment;
