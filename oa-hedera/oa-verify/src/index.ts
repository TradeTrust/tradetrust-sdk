...
import { openAttestationHederaTokenRegistryStatus } from "./verifiers/documentStatus/tokenRegistry";
import { openAttestationHederaDocumentStoreStatus } from "./verifiers/documentStatus/documentStore";
...
const defaultBuilderOption = {
  network: process.env.PROVIDER_NETWORK || "testnet",
};
...
export * from "./verifiers/documentStatus/documentStore/hederaDocumentStoreStatus.type";
export * from "./verifiers/documentStatus/tokenRegistry/hederaTokenRegistryStatus.type";
