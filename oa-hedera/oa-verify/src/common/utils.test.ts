import {
  ...
  getOpenAttestationHederaDocumentStoreStatusFragment,
  getOpenAttestationHederaTokenRegistryStatusFragment,
...
const fragments: AllVerificationFragment[] = [
  ...
  {
    name: "OpenAttestationHederaTokenRegistryStatus",
    reason: {
      code: 4,
      codeString: "SKIPPED",
  ...
  },
  {
    ...
    name: "OpenAttestationHederaDocumentStoreStatus",
    status: "VALID",
    type: "DOCUMENT_STATUS",
  },
  {
...
describe("getFragmentByName", () => {
  ...
  it("should return OpenAttestationHederaDocumentStoreStatus fragment", () => {
    expect(getOpenAttestationHederaDocumentStoreStatusFragment(fragments)).toMatchInlineSnapshot(`
      Object {
        "data": Object {
          "details": Object {
            "issuance": Array [
  ...
  it("should return OpenAttestationHederaTokenRegistryStatus fragment", () => {
    expect(getOpenAttestationHederaTokenRegistryStatusFragment(fragments)).toMatchInlineSnapshot(`
      Object {
        "name": "OpenAttestationHederaTokenRegistryStatus",
        "reason": Object {
          "code": 4,
...
describe("serverError", () => {
  it("should return true of the reason of the error is that we can't connect to Hedera for document store issued fragment", () => {
    const verificationFragment: InvalidVerificationFragment<any> = {
      status: "INVALID",
      name: "OpenAttestationHederaDocumentStoreStatus",
      type: "DOCUMENT_STATUS",
  ...
  it("should return true of the reason of the error is that we can't connect to Hedera for token registry minted fragment", () => {
    const verificationFragment: InvalidVerificationFragment<any> = {
      status: "INVALID",
      name: "OpenAttestationHederaTokenRegistryStatus",
      type: "DOCUMENT_STATUS",
  ...
  it("should return false of the reason of the error is not that we can't connect to Hedera for document store issued fragment", () => {
    const verificationFragment: InvalidVerificationFragment<any> = {
      status: "INVALID",
      name: "OpenAttestationHederaDocumentStoreStatus",
      type: "DOCUMENT_STATUS",
  ...
  it("should return false of the reason of the error is not that we can't connect to Hedera for token registry minted fragment", () => {
    const verificationFragment: InvalidVerificationFragment<any> = {
      status: "INVALID",
      name: "OpenAttestationHederaTokenRegistryStatus",
      type: "DOCUMENT_STATUS",
